        ...
        <div className="mx-auto grid max-w-6xl gap-10 md:grid-cols-3">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="mailto:benitaparticipacoes@gmail.com" aria-label="Enviar email para Clínica Benitá" className="text-primary-foreground/60 transition-colors hover:text-primary-foreground">
